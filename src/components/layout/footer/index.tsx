...
const Footer = () => {
  return (
    <div className="bg-my_primary_color text-white py-6">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        <nav className="md:mt-0 mt-8 space-x-4">
          ...
          <Link className="text-white hover:text-gray-300 font-bold" href="/about">
            About
          </Link>
          <Link className="text-white hover:text-gray-300 font-bold" href="/contact">
            Contact
          </Link>
          <Link className="text-white hover:text-gray-300 font-bold" href="/products">
            Products
          </Link>
        </nav>
